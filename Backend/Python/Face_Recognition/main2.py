...
######################### ========== Face Dataset Loader for Training ==========####################################################################3
...
message3 = tk.Label(window, text="Smart Attendance System using Face Recognition in AI", fg="white", bg="#080707", font=('comic', 29, ' bold '))
...
head2 = tk.Label(frame2, text="For New Registrations", fg="black", bg="#00fcca", font=('comic', 17, ' bold '), anchor="center")
head2.pack(fill='x')
